...
for i in range(chunkszie, data1.shape[0], chunkszie):
    ...
    # pred1_test_total = pred1_test + 0.05*pred1_test_tree
    # pred2_test_total = pred2_test + 0.05*pred2_test_tree
    
    pred1_test_total = pred1_test + pred1_test_tree
    pred2_test_total = pred2_test + pred2_test_tree
    
    pred1_test_total_m2 = pred1_test
    pred2_test_total_m2 = pred2_test
    ...
    pred1_label_m2 = (pred1_test_total_m2 >= 0.5)
    pred2_label_m2 = (pred2_test_total_m2 >= 0.5)
    ...
    accuracy1_test_m2 = metrics.accuracy_score(y1_test, pred1_label_m2)
    accuracy2_test_m2 = metrics.accuracy_score(y2_test, pred2_label_m2)
    
    
    fscore1_test = metrics.f1_score(y1_test, pred1_label)
    fscore2_test = metrics.f1_score(y2_test, pred2_label)
    
    fscore1_test_m2 = metrics.f1_score(y1_test, pred1_label_m2)
    fscore2_test_m2 = metrics.f1_score(y2_test, pred2_label_m2)
    ...
    if accuracy1_test >= accuracy1_test_m2:
        accuracy1_total.append(accuracy1_test)
        fscore1_total.append(fscore1_test)
    else:
        accuracy1_total.append(accuracy1_test_m2)
        fscore1_total.append(fscore1_test_m2)
    
    if accuracy2_test >= accuracy2_test_m2:
        accuracy2_total.append(accuracy2_test)
        fscore2_total.append(fscore2_test)
    else:
        accuracy2_total.append(accuracy2_test_m2)
        fscore2_total.append(fscore2_test_m2)
